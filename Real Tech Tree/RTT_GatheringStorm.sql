...
UPDATE Technologies SET Cost= Cost*.85, UITreeRow = 4 WHERE TechnologyType='TECH_MINING';
UPDATE Technologies SET Cost= Cost*.85, UITreeRow = 2 WHERE TechnologyType='TECH_ANIMAL_HUSBANDRY';
